...
blocks:
  - spec-driven-development-others
  - spec-driven-development-clarke
  - spec-driven-development-kiro
  - plan-first
reading_tags:
  - planning-and-structure
  - responsibility-oversight
reading_intro: 'The sources below provide additional context on spec-first workflows, AI oversight, and the planning discipline that makes AI output reliable.'
outro: |
  <p class="reading-conclusion">Spec-driven development is ultimately a control system: it gives teams a shared narrative about what they are building and why, before any model locks in the implementation.</p>
---
